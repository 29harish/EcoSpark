...
export const lessons: Lesson[] = [
  {
    ...
    xpReward: 50,
    description:
      'Discover how Earth stays warm and why too much warmth is a problem.',
    emoji: '🌡️',
    ...
    slides: [
      {
        ...
        content:
          'Certain gases in our atmosphere act like a warm blanket, trapping heat and keeping our planet cozy. This is the greenhouse effect!',
        emoji: '🛏️',
      ...
      },
      {
        ...
        content:
          'Carbon dioxide, methane, and water vapor are the main greenhouse gases. They let sunlight in but slow down heat escaping.',
        emoji: '☁️',
      },
      {
        id: 's3',
        ...
        content:
          'Burning fossil fuels adds extra greenhouse gases. More gases = thicker blanket = hotter planet. This is global warming.',
        emoji: '🔥',
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'Trap heat like a blanket',
          'Create oxygen',
          'Make rain',
        ],
        correctIndex: 1,
        explanation:
          'Greenhouse gases trap heat in the atmosphere, keeping Earth warm — like a blanket!',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation:
          'Carbon dioxide (CO₂) is one of the most important greenhouse gases.',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation:
          'Burning fossil fuels like coal and oil releases extra CO₂ into the atmosphere.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Your carbon footprint is the total amount of greenhouse gases your actions produce, measured in CO₂ equivalent.',
        emoji: '👣',
      ...
      },
      {
        ...
        content:
          "Transportation, home energy use, and food choices are the biggest parts of most people's carbon footprint.",
        emoji: '🚗',
      },
    ],
    quiz: [
      {
        ...
        options: [
          ...
          'Total greenhouse gases from your actions',
          'Amount of carbon in your body',
          'A type of shoe',
        ],
        correctIndex: 1,
        explanation:
          'A carbon footprint measures the total greenhouse gas emissions from your activities.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation:
          "Transportation is one of the biggest contributors to most people's carbon footprint.",
      },
    ],
  },

  {
    ...
    xpReward: 80,
    description:
      'How climate change fuels stronger storms, droughts, and heatwaves.',
    emoji: '🌪️',
    ...
    slides: [
      {
        ...
        content:
          'As the planet warms, weather patterns become more extreme. Hotter days, heavier rain, and stronger storms.',
        emoji: '🌡️',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Climate change leads to more extreme and unpredictable weather events.',
      },
    ],
  },

  {
    ...
    xpReward: 100,
    description:
      'Explore the technologies and actions that can fight climate change.',
    emoji: '💡',
    ...
    slides: [
      {
        ...
        content:
          'Renewable energy, reforestation, and sustainable transportation are key solutions to climate change.',
        emoji: '🌳',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Planting trees absorbs CO₂ and is an important climate solution.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        title: 'Reduce First!',
        content:
          'The best waste is no waste. Reducing what we use is the most powerful of the 3 Rs.',
        emoji: '✂️',
      ...
      },
      {
        ...
        content:
          'Before throwing something away, ask: can I use this again? Glass jars, bags, and containers get second lives.',
        emoji: '🫙',
      },
      {
        id: 's3',
        title: 'Recycle Right',
        content:
          'Recycling turns old materials into new products. But it only works if we sort correctly!',
        emoji: '♻️',
    ...
    quiz: [
      {
        ...
        correctIndex: 2,
        explanation:
          'Reduce comes first — preventing waste is better than managing it.',
      },
      {
        id: 'q2',
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'Reusing items like glass jars gives them a second life before recycling.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Plastic takes hundreds of years to break down. It fills our oceans and harms wildlife.',
        emoji: '🌊',
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Composting creates nutrient-rich soil that helps plants grow.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Old electronics contain valuable materials and toxic chemicals. They need special recycling.',
        emoji: '💻',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'E-waste contains toxic materials and should be recycled at special facilities.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          "Water evaporates, forms clouds, falls as rain, and flows back to the sea. It's a cycle!",
        emoji: '🔄',
      ...
      },
      {
        ...
        content:
          'The sun heats water until it turns into vapor (evaporation). Vapor cools and becomes clouds (condensation).',
        emoji: '☁️',
      },
      {
        id: 's3',
        ...
        content:
          'Water falls as rain or snow, then collects in rivers, lakes, and oceans — ready to start again.',
        emoji: '🌧️',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Evaporation is when water heats up and turns into vapor.',
      },
      {
        id: 'q2',
        ...
        options: [
          ...
          'Fallen as snow on Mars',
          'Powered a spaceship',
          'Been inside a volcano',
        ],
        correctIndex: 0,
        explanation:
          'Water cycles endlessly, so it could have been drunk by dinosaurs!',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation:
          'When water vapor cools, it condenses into clouds.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Shorter showers, fixing leaks, and turning off taps can save huge amounts of water.',
        emoji: '🚰',
    ...
    slides: [
      {
        ...
        content:
          'Pollution, overfishing, and warming threaten ocean life that billions depend on.',
        emoji: '🐠',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Pollution, overfishing, and warming are major threats to oceans.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Climate change and overuse create water scarcity. 2 billion people lack safely managed water.',
        emoji: '💧',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 2,
        explanation:
          'About 2 billion people lack safely managed drinking water.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        title: 'Tiny Heroes',
        content:
          "Bees, butterflies, and hummingbirds pollinate plants. Without them, we wouldn't have most fruits!",
        emoji: '🐝',
      ...
      },
      {
        ...
        content:
          'Pesticides, habitat loss, and climate change are harming pollinators worldwide.',
        emoji: '🦋',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Pollinators transfer pollen between plants, helping them produce fruits and seeds.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation:
          'Bees pollinate about 75% of the crops we eat.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Over 40,000 species are threatened with extinction. Habitat loss and poaching are main causes.',
        emoji: '🦁',
      },
    ],
    quiz: [
...

  {
    ...
    xpReward: 80,
    description:
      'The rainforests of the sea and their fight for survival.',
    emoji: '🪸',
    ...
    slides: [
      {
        ...
        content:
          'Coral reefs cover less than 1% of the ocean floor but host 25% of all marine life.',
        emoji: '🐠',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 2,
        explanation:
          'Coral reefs host about 25% of all marine life despite covering less than 1% of the ocean floor.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Biodiversity keeps ecosystems healthy. Each species plays a role — lose one and the system weakens.',
        emoji: '🌐',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Each species plays a unique role in its ecosystem — losing one weakens the whole system.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Air pollution comes from cars, factories, and burning fuels. It harms health and the planet.',
        emoji: '🏭',
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Cars, factories, and burning fuels are major sources of air pollution.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'There are estimated to be 5.25 trillion pieces of plastic debris in the ocean.',
        emoji: '🌊',
      },
    ],
    quiz: [
    ...
    slides: [
      {
        ...
        content:
          'Too much noise and artificial light disrupt wildlife and human health.',
        emoji: '💡',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Light pollution is excess artificial light that disrupts ecosystems and sleep.',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          'Renewable energy, regulations, and personal actions all reduce pollution.',
        emoji: '✨',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Renewable energy, regulations, and personal actions all help reduce pollution.',
      },
    ],
  },

  {
    ...
    slides: [
      ...
      },
      {
        ...
        content:
          "Solar energy produces no emissions and the sun won't run out for 5 billion years.",
        emoji: '🌞',
      },
    ],
    quiz: [
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation:
          'The sun will shine for about 5 billion more years — a truly renewable source!',
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          "Wind turbines use the wind's kinetic energy to generate electricity.",
        emoji: '🌀',
      },
    ],
    quiz: [
    ...
    slides: [
      {
        ...
        content:
          "Hydroelectric dams use flowing water. Geothermal uses heat from deep underground.",
        emoji: '⚡',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 2,
        explanation:
          "Geothermal energy uses heat from deep within the Earth.",
      },
    ],
  },
    ...
    slides: [
      {
        ...
        content:
          "Battery storage, smart grids, and new technologies are making renewable energy reliable 24/7.",
        emoji: '🔋',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          "Battery storage and smart grids make renewable energy available even when the sun and wind aren't.",
      },
    ],
  },
];
...
export const missions: Mission[] = [
  {
    ...
    description:
      'Skip single-use plastic and carry a reusable water bottle today.',
    emoji: '🍶',
    difficulty: 'Beginner',
    xpReward: 30,
    coinReward: 5,
  ...
  },
  {
    ...
    description:
      'Collect and properly recycle all paper waste from your home.',
    emoji: '📄',
    difficulty: 'Beginner',
    xpReward: 25,
    coinReward: 4,
  ...
  },
  {
    ...
    title: 'Save Water',
    description:
      'Take a 5-minute shower and turn off the tap while brushing.',
    emoji: '🚿',
    difficulty: 'Beginner',
    xpReward: 20,
    coinReward: 4,
  ...
  },
  {
    ...
    description:
      'Plant a seed or sapling and care for it as it grows.',
    emoji: '🌱',
    difficulty: 'Intermediate',
    xpReward: 50,
    coinReward: 8,
  ...
  },
  {
    ...
    description:
      'Go a full day without using any single-use plastic items.',
    emoji: '🚫',
    difficulty: 'Intermediate',
    xpReward: 40,
    coinReward: 6,
  ...
  },
  {
    ...
    description:
      'Eat plant-based meals for a day to reduce your carbon footprint.',
    emoji: '🥗',
    difficulty: 'Intermediate',
    xpReward: 35,
    coinReward: 5,
...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    unlocked: true,
    date: 'Today',
    color: 'from-coral-500 to-sun-500',
  },
  {
    id: 'a5',
    title: 'Gardener',
    description: 'Reach Forest Explorer rank',
    emoji: '🌳',
    unlocked: false,
    color: 'from-leaf-500 to-lagoon-500',
  },
  {
    id: 'a6',
    title: 'Scholar',
  ...
  },
  {
    ...
    description: 'Reach the final garden rank',
    emoji: '🛡️',
    unlocked: false,
    color: 'from-leaf-600 to-sky2-500',
  },
  {
    id: 'a8',
    title: 'Social Star',
    description: 'Reach top 3 on school leaderboard',
    emoji: '⭐',
    unlocked: false,
    color: 'from-sun-400 to-coral-400',
  },
...
export const gardenItems: GardenItem[] = [
  {
    ...
    unlocked: true,
    category: 'tree',
    description: 'Your first tree — just planted!',
  },
  {
    id: 't2',
    name: 'Young Birch',
    ...
    unlocked: true,
    category: 'tree',
    description: 'Growing taller every day',
  },
  {
    id: 't3',
    name: 'Cherry Blossom',
    ...
    unlocked: true,
    category: 'tree',
    description: 'Pink petals in spring',
  },
  {
    id: 't4',
    name: 'Mighty Oak',
    ...
    unlocked: false,
    category: 'tree',
    description: 'Unlocks at Forest Explorer rank',
  },
  {
    id: 't5',
    ...
    unlocked: false,
    category: 'tree',
    description: 'Unlocks at Earth Guardian rank',
  },
  {
    id: 'f1',
    name: 'Sunflower',
  ...
  },
  {
    ...
    unlocked: true,
    category: 'animal',
    description: 'Flutters between flowers',
  },
  {
    id: 'a2',
    name: 'Songbird',
  ...
  },
  {
    ...
    unlocked: true,
    category: 'decoration',
    description: 'A cozy spot to rest',
  },
  {
    id: 'd2',
    name: 'Wind Chime',
    ...
    unlocked: true,
    category: 'decoration',
    description: 'Gentle music in the breeze',
  },
  {
    id: 'd3',
    name: 'Fountain',
  ...
  },
  {
    ...
    unlocked: true,
    category: 'weather',
    description: 'Water for your plants',
  },
  {
    id: 'w3',
    name: 'Rainbow',
...
export const rewards: Reward[] = [
  ...
  },
  {
    ...
    description: 'Decorate your profile with a nature frame',
    emoji: '🖼️',
    cost: 15,
    category: 'digital',
    color: 'from-leaf-400 to-lagoon-400',
  },
  {
    ...
    description: 'A warm sunset theme for your Eco Garden',
    emoji: '🌅',
    cost: 30,
    category: 'digital',
    color: 'from-coral-400 to-sun-400',
  },
  {
    ...
    description: 'A real EcoSpark branded water bottle!',
    emoji: '🍶',
    cost: 50,
    category: 'real',
    color: 'from-lagoon-400 to-sky2-400',
  },
  {
    id: 'r5',
    title: 'Seed Kit',
    description: 'A real kit with seeds to plant at home',
    emoji: '🌻',
    cost: 75,
    category: 'real',
    color: 'from-leaf-500 to-sun-400',
  },
  {
    id: 'r6',
    title: 'Eco T-Shirt',
    description: 'An organic cotton EcoSpark t-shirt',
    emoji: '👕',
    cost: 100,
    category: 'real',
    color: 'from-leaf-400 to-lagoon-500',
  },
  {
    ...
    description:
      'We plant a real tree in a forest restoration project',
    emoji: '🌳',
    cost: 150,
    category: 'real',
  ...
  },
  {
    id: 'r8',
    title: 'Golden Garden',
    description: 'A premium golden theme for your garden',
    emoji: '✨',
    cost: 200,
    category: 'digital',
...
export const challenges: Challenge[] = [
  {
    ...
    description:
      'Join your school in going 7 days without single-use plastic. Every small action adds up!',
    emoji: '🚫',
    participants: 234,
    daysLeft: 5,
    xpReward: 300,
  ...
  },
  {
    ...
    description:
      "School-wide goal to plant 100 trees. Each student's sapling counts toward the total.",
    emoji: '🌳',
    participants: 156,
    daysLeft: 18,
    xpReward: 500,
  ...
  },
  {
    ...
    description:
      'Reduce home electricity use for 14 days. Track your savings and learn energy tips.',
    emoji: '⚡',
    participants: 89,
    daysLeft: 12,
    xpReward: 400,
  ...
  },
  {
    ...
    description:
      'Save 50 gallons of water in a week through daily conservation actions.',
    emoji: '💧',
    participants: 112,
    daysLeft: 7,
    xpReward: 250,
...
export const gardenRanks = [
  ...
  },
  {
    ...
    emoji: '🌍',
    color: 'from-leaf-600 to-sky2-500',
    description: 'A true protector of nature',
  },
];
...
export const aiGuideSuggestions = [
  ...
  {
    id: 's2',
    text: 'What should I recycle first?',
    emoji: '♻️',
  },
  {
    id: 's3',
    text: 'Tell me about endangered animals',
    emoji: '🐼',
  },
  {
    id: 's4',
  ...
  {
    id: 's5',
    text: 'Ways to save water at home',
    emoji: '💧',
  },
  {
    id: 's6',
